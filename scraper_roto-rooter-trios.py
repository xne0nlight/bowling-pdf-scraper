...
def send_email(filename):
    msg = MIMEText(f"A new PDF is available: https://jeffjohnsononline.com/league_pdfs/roto-rooter-trios/{filename}")
...
with FTP(FTP_HOST) as ftp:
    ftp.login(FTP_USERNAME, FTP_PASSWORD)
    ensure_directory(ftp, 'league_pdfs/roto-rooter-trios')
